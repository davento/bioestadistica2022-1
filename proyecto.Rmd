...
creamos funciones para poder resumir las variables a tomar en cuenta.
...
cat('agressor age\n')
analyze_single_var( df$agressor_age)
...
Vemos el porcentaje de incidencias por region
...
Procedemos a graficar la distribucion para las variables
...
A continuacion se haran las pruebas de normalidad con las funciones descritas:




Retorna de acuerdo con la prueba de lillie si es parametrico y/o tiene
...
Defenimos como vamos a graficar las distribuciones
...
Lo vereficamos con un grafico de barplot
